...
/*
* TODO(pts5di): Write your own ECHO test based on PerformWriteReadTest
* - Rather than taking in a TestLength and *generating* a pattern, take a char* and write/read that instead.
*/
